...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main" style="background-color:RGB(51,51,51);">
		<div class="logo margin-big-left fadein-top">
			<h1>
				<img src="img/logo.png" class="radius-circle rotate-hover"
					height="50" alt="" />后台管理中心
			</h1>
		</div>
		<div class="head-l">
			<a href="javascript:void(0);" class="button button-little bg-blue"><span
				class="icon-user"></span> ${user.usertruename}(${user.rolename})</a>
			&nbsp;&nbsp; <a class="button button-little bg-red"
				href="<%=basePath%>UserServlet?cmd=logout" target="_self"><span
				class="icon-power-off"></span> 退出登录</a>
		</div>
	</div>
	<div class="leftnav" style="background-color:RGB(51,51,51);color:white">
		<div class="leftnav-title">
			<strong style="color:white"><span class="icon-list" style="color:white"></span>菜单列表</strong>
		</div>
		<c:forEach items="${list}" var="top">
			<c:if test="${top.funpid==\"-1\"}">
				<h2>
					<span class="icon-briefcase"></span>${top.funname}</h2>
